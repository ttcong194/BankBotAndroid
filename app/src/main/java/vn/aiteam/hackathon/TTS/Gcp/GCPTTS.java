...
public class GCPTTS {
    ...
    private MediaPlayer.OnCompletionListener audioCompleteListener;
    ...
    private void playAudio(String base64EncodedString) {
        try {
            ...
            if(audioCompleteListener != null) {
                mMediaPlayer.setOnCompletionListener(audioCompleteListener);
            }
    ...
    public void addCompleteListener(MediaPlayer.OnCompletionListener completionListener) {
       this.audioCompleteListener = completionListener;
    }
