...
public class OutcomingCameraMessageViewHolder extends MessageHolders.OutcomingTextMessageViewHolder<Message> {

    private ImageView imv;

    public OutcomingCameraMessageViewHolder(View itemView, Object payload) {
